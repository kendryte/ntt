...
TEST(PackTest_Float8e4m3, Float8e4m3_fixed_1D_vector_contiguous_pack_axis_2_3D) {
    ...
    // 1. create NTT input 
    // ------------------------------------------------------------------
    auto ntt_input = ntt::make_tensor<float_e4m3_t>(ntt::fixed_shape_v<C, H, W>);
    ...
    auto ntt_output1 = ntt::make_tensor<ntt::vector<float_e4m3_t, P>>(ntt::fixed_shape_v<C, H, W / P>);
...
TEST(PackTest_Float8e4m3, Float8e4m3_fixed_1D_vector_contiguous_pack_axis_1_3D) {
    ...
    // ------------------------------------------------------------------
    // Create output tensor
    auto ntt_output1 = ntt::make_tensor<ntt::vector<float_e4m3_t, P>>(ntt::fixed_shape_v<C, H / P, W>);
...
TEST(PackTest_Float8e4m3, Float8e4m3_fixed_1D_vector_contiguous_pack_axis_0_3D) {
    ...
    // ------------------------------------------------------------------
    // Create output tensor
    auto ntt_output1 = ntt::make_tensor<ntt::vector<float_e4m3_t, P>>(ntt::fixed_shape_v<C / P, H, W>);
...
TEST(PackTest_Float8e4m3, Float8e4m3_fixed_1D_vector_non_contiguous_dim1_mul2_pack_axis_2_3D) {
    ...
    auto big_tensor = ntt::make_tensor<float_e4m3_t>(ntt::fixed_shape_v<C, (H) *2, W>);
...
TEST(PackTest_Float8e4m3, Float8e4m3_fixed_2D_vector_contiguous_pack_axis_0_1_3D) {
    ...
    // ------------------------------------------------------------------
    // Create output tensor
    auto ntt_output1 = ntt::make_tensor<ntt::vector<float_e4m3_t, P, P>>(ntt::fixed_shape_v<C / P, H / P, W>);
...
TEST(PackTest_Float8e4m3, Float8e4m3_fixed_2D_vector_contiguous_pack_axis_1_2_3D) {
    ...
    // ------------------------------------------------------------------
    // Create output tensor
    auto ntt_output1 = ntt::make_tensor<ntt::vector<float_e4m3_t, P, P>>(ntt::fixed_shape_v<C, H / P, W / P>);
...
TEST(PackTest_Float8e4m3, Float8e4m3_dynamic_1D_vector_contiguous_pack_axis_2_3D) {
    ...
    // 1. create NTT input 
    // ------------------------------------------------------------------
    auto ntt_input = ntt::make_tensor<float_e4m3_t>(ntt::make_shape(C, H, W));
    NttTest::init_tensor(ntt_input, min_input, max_input);
    ...
    // ------------------------------------------------------------------
    // Create output tensor
    auto ntt_output1 = ntt::make_tensor<ntt::vector<float_e4m3_t, P>>(ntt::make_shape(C, H, W / P));
...
TEST(PackTest_Float8e4m3, Float8e4m3_dynamic_1D_vector_contiguous_pack_axis_1_3D) {
    ...
    // ------------------------------------------------------------------
    // Create output tensor
    auto ntt_output1 = ntt::make_tensor<ntt::vector<float_e4m3_t, P>>(ntt::make_shape(C, H / P, W));
...
TEST(PackTest_Float8e4m3, Float8e4m3_dynamic_1D_vector_contiguous_pack_axis_0_3D) {
    ...
    // ------------------------------------------------------------------
    // Create output tensor
    auto ntt_output1 = ntt::make_tensor<ntt::vector<float_e4m3_t, P>>(ntt::make_shape(C / P, H, W));
...
TEST(PackTest_Float8e4m3, Float8e4m3_dynamic_1D_vector_non_contiguous_dim1_mul2_pack_axis_2_3D) {
    ...
    // ------------------------------------------------------------------
    // Create non-contiguous tensor (on dimension 1)
    auto big_tensor = ntt::make_tensor<float_e4m3_t>(ntt::make_shape(C, (H) *2, W));
    NttTest::init_tensor(big_tensor, min_input, max_input);
...
TEST(PackTest_Float8e4m3, Float8e4m3_dynamic_2D_vector_contiguous_pack_axis_0_1_3D) {
    ...
    // ------------------------------------------------------------------
    // Create output tensor
    auto ntt_output1 = ntt::make_tensor<ntt::vector<float_e4m3_t, P, P>>(ntt::make_shape(C / P, H / P, W));
...
TEST(PackTest_Float8e4m3, Float8e4m3_dynamic_2D_vector_contiguous_pack_axis_1_2_3D) {
    ...
    // ------------------------------------------------------------------
    // Create output tensor
    auto ntt_output1 = ntt::make_tensor<ntt::vector<float_e4m3_t, P, P>>(ntt::make_shape(C, H / P, W / P));
...
TEST(PackTest_Float8e4m3, Float8e4m3_fixed_1D_vector_contiguous_pack_axis_3_4D) {
    ...
    // 1. create NTT input 
    // ------------------------------------------------------------------
    auto ntt_input = ntt::make_tensor<float_e4m3_t>(ntt::fixed_shape_v<N, C, H, W>);
    NttTest::init_tensor(ntt_input, min_input, max_input);
    ...
    // ------------------------------------------------------------------
    // Create output tensor
    auto ntt_output1 = ntt::make_tensor<ntt::vector<float_e4m3_t, P>>(ntt::fixed_shape_v<N, C, H, W / P>);
...
TEST(PackTest_Float8e4m3, Float8e4m3_fixed_1D_vector_contiguous_pack_axis_2_4D) {
    ...
    // ------------------------------------------------------------------
    // Create output tensor
    auto ntt_output1 = ntt::make_tensor<ntt::vector<float_e4m3_t, P>>(ntt::fixed_shape_v<N, C, H / P, W>);
...
TEST(PackTest_Float8e4m3, Float8e4m3_fixed_1D_vector_contiguous_pack_axis_1_4D) {
    ...
    // ------------------------------------------------------------------
    // Create output tensor
    auto ntt_output1 = ntt::make_tensor<ntt::vector<float_e4m3_t, P>>(ntt::fixed_shape_v<N, C / P, H, W>);
...
TEST(PackTest_Float8e4m3, Float8e4m3_fixed_1D_vector_contiguous_pack_axis_0_4D) {
    ...
    // ------------------------------------------------------------------
    // Create output tensor
    auto ntt_output1 = ntt::make_tensor<ntt::vector<float_e4m3_t, P>>(ntt::fixed_shape_v<N / P, C, H, W>);
...
TEST(PackTest_Float8e4m3, Float8e4m3_fixed_1D_vector_non_contiguous_dim2_add5_pack_axis_3_4D) {
    ...
    auto big_tensor = ntt::make_tensor<float_e4m3_t>(ntt::fixed_shape_v<N, C, (H) +7, W>);
    NttTest::init_tensor(big_tensor, min_input, max_input);
...
TEST(PackTest_Float8e4m3, Float8e4m3_fixed_1D_vector_non_contiguous_dim2_mul2_pack_axis_3_4D) {
    ...
    // ------------------------------------------------------------------
    // Create non-contiguous tensor (on dimension 2)
    auto big_tensor = ntt::make_tensor<float_e4m3_t>(ntt::fixed_shape_v<N, C, (H) *2, W>);
    NttTest::init_tensor(big_tensor, min_input, max_input);
...
TEST(PackTest_Float8e4m3, Float8e4m3_fixed_1D_vector_non_contiguous_dim1_mul2_pack_axis_3_4D) {
    ...
    // ------------------------------------------------------------------
    // Create non-contiguous tensor (on dimension 1)
    auto big_tensor = ntt::make_tensor<float_e4m3_t>(ntt::fixed_shape_v<N, (C) *2, H, W>);
    NttTest::init_tensor(big_tensor, min_input, max_input);
...
TEST(PackTest_Float8e4m3, Float8e4m3_fixed_1D_vector_non_contiguous_dim1_add5_pack_axis_3_4D) {
    ...
    // ------------------------------------------------------------------
    // Create non-contiguous tensor (on dimension 1)
    auto big_tensor = ntt::make_tensor<float_e4m3_t>(ntt::fixed_shape_v<N, (C) +7, H, W>);
    NttTest::init_tensor(big_tensor, min_input, max_input);
...
TEST(PackTest_Float8e4m3, Float8e4m3_fixed_2D_vector_contiguous_pack_axis_0_1_4D) {
    ...
    // ------------------------------------------------------------------
    // Create output tensor
    auto ntt_output1 = ntt::make_tensor<ntt::vector<float_e4m3_t, P, P>>(ntt::fixed_shape_v<N / P, C / P, H, W>);
...
TEST(PackTest_Float8e4m3, Float8e4m3_fixed_2D_vector_contiguous_pack_axis_1_2_4D) {
    ...
    // ------------------------------------------------------------------
    // Create output tensor
    auto ntt_output1 = ntt::make_tensor<ntt::vector<float_e4m3_t, P, P>>(ntt::fixed_shape_v<N, C / P, H / P, W>);
...
TEST(PackTest_Float8e4m3, Float8e4m3_fixed_2D_vector_contiguous_pack_axis_2_3_4D) {
    ...
    // ------------------------------------------------------------------
    // Create output tensor
    auto ntt_output1 = ntt::make_tensor<ntt::vector<float_e4m3_t, P, P>>(ntt::fixed_shape_v<N, C, H / P, W / P>);
...
TEST(PackTest_Float8e4m3, Float8e4m3_dynamic_1D_vector_contiguous_pack_axis_3_4D) {
    ...
    // 1. create NTT input 
    // ------------------------------------------------------------------
    auto ntt_input = ntt::make_tensor<float_e4m3_t>(ntt::make_shape(N, C, H, W));
    NttTest::init_tensor(ntt_input, min_input, max_input);
    ...
    // ------------------------------------------------------------------
    // Create output tensor
    auto ntt_output1 = ntt::make_tensor<ntt::vector<float_e4m3_t, P>>(ntt::make_shape(N, C, H, W / P));
...
TEST(PackTest_Float8e4m3, Float8e4m3_dynamic_1D_vector_contiguous_pack_axis_2_4D) {
    ...
    // ------------------------------------------------------------------
    // Create output tensor
    auto ntt_output1 = ntt::make_tensor<ntt::vector<float_e4m3_t, P>>(ntt::make_shape(N, C, H / P, W));
...
TEST(PackTest_Float8e4m3, Float8e4m3_dynamic_1D_vector_contiguous_pack_axis_1_4D) {
    ...
    // ------------------------------------------------------------------
    // Create output tensor
    auto ntt_output1 = ntt::make_tensor<ntt::vector<float_e4m3_t, P>>(ntt::make_shape(N, C / P, H, W));
...
TEST(PackTest_Float8e4m3, Float8e4m3_dynamic_1D_vector_contiguous_pack_axis_0_4D) {
    ...
    // ------------------------------------------------------------------
    // Create output tensor
    auto ntt_output1 = ntt::make_tensor<ntt::vector<float_e4m3_t, P>>(ntt::make_shape(N / P, C, H, W));
...
TEST(PackTest_Float8e4m3, Float8e4m3_dynamic_1D_vector_non_contiguous_dim2_add5_pack_axis_3_4D) {
    ...
    // ------------------------------------------------------------------
    // Create non-contiguous tensor (on dimension 2)
    auto big_tensor = ntt::make_tensor<float_e4m3_t>(ntt::make_shape(N, C, (H) +7, W));
    NttTest::init_tensor(big_tensor, min_input, max_input);
...
TEST(PackTest_Float8e4m3, Float8e4m3_dynamic_1D_vector_non_contiguous_dim2_mul2_pack_axis_3_4D) {
    ...
    // ------------------------------------------------------------------
    // Create non-contiguous tensor (on dimension 2)
    auto big_tensor = ntt::make_tensor<float_e4m3_t>(ntt::make_shape(N, C, (H) *2, W));
    NttTest::init_tensor(big_tensor, min_input, max_input);
...
TEST(PackTest_Float8e4m3, Float8e4m3_dynamic_1D_vector_non_contiguous_dim1_mul2_pack_axis_3_4D) {
    ...
    // ------------------------------------------------------------------
    // Create non-contiguous tensor (on dimension 1)
    auto big_tensor = ntt::make_tensor<float_e4m3_t>(ntt::make_shape(N, (C) *2, H, W));
    NttTest::init_tensor(big_tensor, min_input, max_input);
...
TEST(PackTest_Float8e4m3, Float8e4m3_dynamic_1D_vector_non_contiguous_dim1_add5_pack_axis_3_4D) {
    ...
    // ------------------------------------------------------------------
    // Create non-contiguous tensor (on dimension 1)
    auto big_tensor = ntt::make_tensor<float_e4m3_t>(ntt::make_shape(N, (C) +7, H, W));
    NttTest::init_tensor(big_tensor, min_input, max_input);
...
TEST(PackTest_Float8e4m3, Float8e4m3_dynamic_2D_vector_contiguous_pack_axis_0_1_4D) {
    ...
    // ------------------------------------------------------------------
    // Create output tensor
    auto ntt_output1 = ntt::make_tensor<ntt::vector<float_e4m3_t, P, P>>(ntt::make_shape(N / P, C / P, H, W));
...
TEST(PackTest_Float8e4m3, Float8e4m3_dynamic_2D_vector_contiguous_pack_axis_1_2_4D) {
    ...
    // ------------------------------------------------------------------
    // Create output tensor
    auto ntt_output1 = ntt::make_tensor<ntt::vector<float_e4m3_t, P, P>>(ntt::make_shape(N, C / P, H / P, W));
...
TEST(PackTest_Float8e4m3, Float8e4m3_dynamic_2D_vector_contiguous_pack_axis_2_3_4D) {
    ...
    // ------------------------------------------------------------------
    // Create output tensor
    auto ntt_output1 = ntt::make_tensor<ntt::vector<float_e4m3_t, P, P>>(ntt::make_shape(N, C, H / P, W / P));
...
TEST(PackTest_Float8e4m3, Float8e4m3_fixed_1D_vector_contiguous_pack_axis_4_5D) {
    ...
    // 1. create NTT input 
    // ------------------------------------------------------------------
    auto ntt_input = ntt::make_tensor<float_e4m3_t>(ntt::fixed_shape_v<N, C, H, W, D>);
    NttTest::init_tensor(ntt_input, min_input, max_input);
    ...
    // ------------------------------------------------------------------
    // Create output tensor
    auto ntt_output1 = ntt::make_tensor<ntt::vector<float_e4m3_t, P>>(ntt::fixed_shape_v<N, C, H, W, D / P>);
...
TEST(PackTest_Float8e4m3, Float8e4m3_fixed_1D_vector_contiguous_pack_axis_3_5D) {
    ...
    // ------------------------------------------------------------------
    // Create output tensor
    auto ntt_output1 = ntt::make_tensor<ntt::vector<float_e4m3_t, P>>(ntt::fixed_shape_v<N, C, H, W / P, D>);
...
TEST(PackTest_Float8e4m3, Float8e4m3_fixed_1D_vector_contiguous_pack_axis_2_5D) {
    ...
    // ------------------------------------------------------------------
    // Create output tensor
    auto ntt_output1 = ntt::make_tensor<ntt::vector<float_e4m3_t, P>>(ntt::fixed_shape_v<N, C, H / P, W, D>);
...
TEST(PackTest_Float8e4m3, Float8e4m3_fixed_1D_vector_contiguous_pack_axis_1_5D) {
    ...
    // ------------------------------------------------------------------
    // Create output tensor
    auto ntt_output1 = ntt::make_tensor<ntt::vector<float_e4m3_t, P>>(ntt::fixed_shape_v<N, C / P, H, W, D>);
...
TEST(PackTest_Float8e4m3, Float8e4m3_fixed_1D_vector_contiguous_pack_axis_0_5D) {
    ...
    // ------------------------------------------------------------------
    // Create output tensor
    auto ntt_output1 = ntt::make_tensor<ntt::vector<float_e4m3_t, P>>(ntt::fixed_shape_v<N / P, C, H, W, D>);
...
TEST(PackTest_Float8e4m3, Float8e4m3_fixed_1D_vector_non_contiguous_dim1_mul2_pack_axis_4_5D) {
    ...
    // ------------------------------------------------------------------
    // Create non-contiguous tensor (on dimension 1)
    auto big_tensor = ntt::make_tensor<float_e4m3_t>(ntt::fixed_shape_v<N, (C) *2, H, W, D>);
    NttTest::init_tensor(big_tensor, min_input, max_input);
...
TEST(PackTest_Float8e4m3, Float8e4m3_fixed_2D_vector_contiguous_pack_axis_0_1_5D) {
    ...
    // ------------------------------------------------------------------
    // Create output tensor
    auto ntt_output1 = ntt::make_tensor<ntt::vector<float_e4m3_t, P, P>>(ntt::fixed_shape_v<N / P, C / P, H, W, D>);
...
TEST(PackTest_Float8e4m3, Float8e4m3_fixed_2D_vector_contiguous_pack_axis_1_2_5D) {
    ...
    // ------------------------------------------------------------------
    // Create output tensor
    auto ntt_output1 = ntt::make_tensor<ntt::vector<float_e4m3_t, P, P>>(ntt::fixed_shape_v<N, C / P, H / P, W, D>);
...
TEST(PackTest_Float8e4m3, Float8e4m3_fixed_2D_vector_contiguous_pack_axis_2_3_5D) {
    ...
    // ------------------------------------------------------------------
    // Create output tensor
    auto ntt_output1 = ntt::make_tensor<ntt::vector<float_e4m3_t, P, P>>(ntt::fixed_shape_v<N, C, H / P, W / P, D>);
...
TEST(PackTest_Float8e4m3, Float8e4m3_fixed_2D_vector_contiguous_pack_axis_3_4_5D) {
    ...
    // ------------------------------------------------------------------
    // Create output tensor
    auto ntt_output1 = ntt::make_tensor<ntt::vector<float_e4m3_t, P, P>>(ntt::fixed_shape_v<N, C, H, W / P, D / P>);
...
TEST(PackTest_Float8e4m3, Float8e4m3_dynamic_1D_vector_contiguous_pack_axis_4_5D) {
    ...
    // 1. create NTT input 
    // ------------------------------------------------------------------
    auto ntt_input = ntt::make_tensor<float_e4m3_t>(ntt::make_shape(N, C, H, W, D));
    NttTest::init_tensor(ntt_input, min_input, max_input);
    ...
    // ------------------------------------------------------------------
    // Create output tensor
    auto ntt_output1 = ntt::make_tensor<ntt::vector<float_e4m3_t, P>>(ntt::make_shape(N, C, H, W, D / P));
...
TEST(PackTest_Float8e4m3, Float8e4m3_dynamic_1D_vector_contiguous_pack_axis_3_5D) {
    ...
    // ------------------------------------------------------------------
    // Create output tensor
    auto ntt_output1 = ntt::make_tensor<ntt::vector<float_e4m3_t, P>>(ntt::make_shape(N, C, H, W / P, D));
...
TEST(PackTest_Float8e4m3, Float8e4m3_dynamic_1D_vector_contiguous_pack_axis_2_5D) {
    ...
    // ------------------------------------------------------------------
    // Create output tensor
    auto ntt_output1 = ntt::make_tensor<ntt::vector<float_e4m3_t, P>>(ntt::make_shape(N, C, H / P, W, D));
...
TEST(PackTest_Float8e4m3, Float8e4m3_dynamic_1D_vector_contiguous_pack_axis_1_5D) {
    ...
    // ------------------------------------------------------------------
    // Create output tensor
    auto ntt_output1 = ntt::make_tensor<ntt::vector<float_e4m3_t, P>>(ntt::make_shape(N, C / P, H, W, D));
...
TEST(PackTest_Float8e4m3, Float8e4m3_dynamic_1D_vector_contiguous_pack_axis_0_5D) {
    ...
    // ------------------------------------------------------------------
    // Create output tensor
    auto ntt_output1 = ntt::make_tensor<ntt::vector<float_e4m3_t, P>>(ntt::make_shape(N / P, C, H, W, D));
...
TEST(PackTest_Float8e4m3, Float8e4m3_dynamic_1D_vector_non_contiguous_dim1_mul2_pack_axis_4_5D) {
    ...
    // ------------------------------------------------------------------
    // Create non-contiguous tensor (on dimension 1)
    auto big_tensor = ntt::make_tensor<float_e4m3_t>(ntt::make_shape(N, (C) *2, H, W, D));
    NttTest::init_tensor(big_tensor, min_input, max_input);
...
TEST(PackTest_Float8e4m3, Float8e4m3_dynamic_2D_vector_contiguous_pack_axis_0_1_5D) {
    ...
    // ------------------------------------------------------------------
    // Create output tensor
    auto ntt_output1 = ntt::make_tensor<ntt::vector<float_e4m3_t, P, P>>(ntt::make_shape(N / P, C / P, H, W, D));
...
TEST(PackTest_Float8e4m3, Float8e4m3_dynamic_2D_vector_contiguous_pack_axis_1_2_5D) {
    ...
    // ------------------------------------------------------------------
    // Create output tensor
    auto ntt_output1 = ntt::make_tensor<ntt::vector<float_e4m3_t, P, P>>(ntt::make_shape(N, C / P, H / P, W, D));
...
TEST(PackTest_Float8e4m3, Float8e4m3_dynamic_2D_vector_contiguous_pack_axis_2_3_5D) {
    ...
    // ------------------------------------------------------------------
    // Create output tensor
    auto ntt_output1 = ntt::make_tensor<ntt::vector<float_e4m3_t, P, P>>(ntt::make_shape(N, C, H / P, W / P, D));
...
TEST(PackTest_Float8e4m3, Float8e4m3_dynamic_2D_vector_contiguous_pack_axis_3_4_5D) {
    ...
    // ------------------------------------------------------------------
    // Create output tensor
    auto ntt_output1 = ntt::make_tensor<ntt::vector<float_e4m3_t, P, P>>(ntt::make_shape(N, C, H, W / P, D / P));
